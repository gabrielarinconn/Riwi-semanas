...
- [x] El sistema debe iniciar con al menos 5 productos pre-cargados.
- [x] Todas las interacciones deben estar en inglés, incluidos comentarios, mensajes y documentación.
- [x] Se deben aplicar buenas prácticas de codificación: funciones claras, uso de constantes, validaciones.
- [x] El programa debe correr por consola y ofrecer un menú interactivo.
- [x] El código debe manejar excepciones sin que el programa se detenga abruptamente.
