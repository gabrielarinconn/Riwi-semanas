# main.py
import data_managers # Importa funciones de carga/guardado
...
def main_menu():
    ...
    data_managers.load_data() 
    
    while True:
        print("\n" + "#"*40)
        print("--- 📖 🪼 Gabi JellyFish Library  🪼 📖 ---")
        print("📦 E-Store Inventory's & Sales System")
        print("#"*40)
